...
const Terminal = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "bg-terminal-bg/50 w-full rounded-xl border-border border h-[600px] flex flex-col backdrop-blur-md shadow-xl z-[5]",
        className
      )}
      {...motionProps}
    >
      ...
      <div
        className={cn(
          "w-full flex-grow py-2 px-4 text-body text-terminal-fg flex flex-col gap-[0.125rem] justify-center",
          firaCode.className,
